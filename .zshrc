...
export ZSH="/Users/YCC/.oh-my-zsh"
...
# alias gcloudg='gcloud compute --project "invertible-spot-221218" ssh --zone "us-east1-c" "rstudio"'
...
__conda_setup="$('/Users/YCC/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/YCC/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/YCC/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/YCC/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
